...
(def configuration {:command     "google-drive-clj"
                    ...
                    :subcommands [{:command     "search-by-type"
                                  ...
                                  {:command     "move-file"
                                   ...
                                   :examples    ["move-file name-of-file name-of-dir"]
                                   :opts        [{:option "type" :short "a" :as "First argument (type)"
                                                  :type   :string}
                                                 {:option "name" :short "b" :as "Second argument (name)"
                                                  :type   :string}]
                                   #_[{:as     ["What is the name of a file? "]
                                       :type   :string
                                       :option "a"}
                                      {:as     ["What is the name of a directory? "]
                                       :type   :string
                                       :option "b"}]
                                   :runs        move-file}
                                  ]})
